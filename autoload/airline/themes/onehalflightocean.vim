...
let g:airline#themes#onehalflightocean#palette = {}
...
let g:airline#themes#onehalflightocean#palette.normal = 
    \ airline#themes#generate_color_map(s:normal_outer, s:normal_middle, s:normal_inner)
let g:airline#themes#onehalflightocean#palette.normal_modified =
...
let g:airline#themes#onehalflightocean#palette.insert = 
...
let g:airline#themes#onehalflight#palette.insert_modified = 
    \ copy(g:airline#themes#onehalflightocean#palette.normal_modified)
...
let g:airline#themes#onehalflightocean#palette.replace =
    \ airline#themes#generate_color_map(s:replace_outer, s:replace_middle, s:replace_inner)
let g:airline#themes#onehalflightocean#palette.replace_modified = 
    \ copy(g:airline#themes#onehalflightocean#palette.insert_modified)
...
let g:airline#themes#onehalflightocean#palette.visual = 
    \ airline#themes#generate_color_map(s:visual_outer, s:visual_middle, s:visual_inner)
let g:airline#themes#onehalflightocean#palette.visual_modified = 
    \ copy(g:airline#themes#onehalflightocean#palette.insert_modified)
...
let g:airline#themes#onehalflightocean#palette.inactive = 
    \ airline#themes#generate_color_map(s:inactive, s:inactive, s:inactive)
let g:airline#themes#onehalflightocean#palette.inactive_modified = 
