...
let g:airline#themes#onehalfoceandark#palette = {}
...
let g:airline#themes#onehalfdarkocean#palette.normal = 
    \ airline#themes#generate_color_map(s:normal_outer, s:normal_middle, s:normal_inner)
let g:airline#themes#onehalfdarkocean#palette.normal_modified =
...
let g:airline#themes#onehalfdarkocean#palette.insert = 
    \ airline#themes#generate_color_map(s:insert_outer, s:insert_middle, s:insert_inner)
let g:airline#themes#onehalfdarkocean#palette.insert_modified = 
    \ copy(g:airline#themes#onehalfdarkocean#palette.normal_modified)
...
let g:airline#themes#onehalfdarkocean#palette.replace =
    \ airline#themes#generate_color_map(s:replace_outer, s:replace_middle, s:replace_inner)
let g:airline#themes#onehalfdarkocean#palette.replace_modified = 
    \ copy(g:airline#themes#onehalfdarkocean#palette.insert_modified)
...
let g:airline#themes#onehalfdarkocean#palette.visual = 
    \ airline#themes#generate_color_map(s:visual_outer, s:visual_middle, s:visual_inner)
let g:airline#themes#onehalfdarkocean#palette.visual_modified = 
    \ copy(g:airline#themes#onehalfdarkocean#palette.insert_modified)
...
let g:airline#themes#onehalfdarkocean#palette.inactive = 
    \ airline#themes#generate_color_map(s:inactive, s:inactive, s:inactive)
let g:airline#themes#onehalfdarkocean#palette.inactive_modified = 
