...
let g:colors_name="onehalfdarkkalid"
let colors_name="onehalfdarkkalid"


let s:black       = { "gui": "#292b49", "cterm": "236" }
let s:red         = { "gui": "#e06c75", "cterm": "168" }
let s:green       = { "gui": "#98c379", "cterm": "114" }
let s:light_green = { "gui": "#C3E88D", "cterm": "114" }
let s:yellow      = { "gui": "#e5c07b", "cterm": "180" }
let s:orange      = { "gui": "#F78C6C", "cterm": "180" }
let s:blue        = { "gui": "#61afef", "cterm": "75"  }
let s:purple      = { "gui": "#C792EA", "cterm": "176" }
let s:cyan        = { "gui": "#56b6c2", "cterm": "73"  }
let s:white       = { "gui": "#dcdfe4", "cterm": "188" }
let s:light_gray  = { "gui": "#8F93A2", "cterm": "232" }

let s:fg          = s:white
let s:bg          = s:black

let s:comment_fg  = { "gui": "#464B5D", "cterm": "241" }
let s:gutter_bg   = { "gui": "#2c2e4f", "cterm": "236" }
...
call s:h("String", s:light_green, "", "")
call s:h("Character", s:light_green, "", "")
call s:h("Number", s:orange, "", "")
call s:h("Boolean", s:orange, "", "")
call s:h("Float", s:orange, "", "")

call s:h("Identifier", s:light_gray, "", "")
...
call s:h("Tag", s:blue, "", "")
call s:h("Delimiter", s:blue, "", "")
call s:h("SpecialComment", s:blue, "", "")
call s:h("Debug", s:blue, "", "")
call s:h("Underlined", s:blue,"", "")
call s:h("Ignore", s:blue,"", "")
